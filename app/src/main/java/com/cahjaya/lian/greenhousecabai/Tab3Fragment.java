...
public class Tab3Fragment extends Fragment {
    ...
    SimpleDateFormat sdfsuhu=new SimpleDateFormat(  "MM", Locale.getDefault());
    SimpleDateFormat sdfhmdt=new SimpleDateFormat(  "MM", Locale.getDefault());
    SimpleDateFormat sdfktanah=new SimpleDateFormat(  "MM", Locale.getDefault());
