...
public class Tab2Fragment extends Fragment {
    ...
    SimpleDateFormat sdfsuhu=new SimpleDateFormat(  "DD", Locale.getDefault());
    SimpleDateFormat sdfhmdt=new SimpleDateFormat(  "DD", Locale.getDefault());
    SimpleDateFormat sdfktanah=new SimpleDateFormat(  "DD", Locale.getDefault());
