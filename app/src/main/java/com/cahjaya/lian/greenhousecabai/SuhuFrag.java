...
public class SuhuFrag extends Fragment {
    View myView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View myView = inflater.inflate(R.layout.fragsuhu, container, false);
        ...
        chartkonf();
        resetsuhu();
        final TabLayout tabLayout = myView.findViewById(R.id.tab_layouts);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(tabLayout.getSelectedTabPosition() == 0){
                    graphViewsuhu.getGridLabelRenderer().setNumHorizontalLabels(9);
                    graphViewsuhu.getViewport().setMinX(xktanah0-432);
                    legsj.setText("□ Suhu °C   □ Waktu Jam, Tanggal");
                    ...
                    graphViewsuhu.getGridLabelRenderer().setNumHorizontalLabels(4);
                    graphViewsuhu.getViewport().setMinX(xktanah0-25920);
                    legsj.setText("□ Suhu °C   □ Waktu Tanggal, Bulan");
                    sdfsuhu=new SimpleDateFormat(  "dd, MMM", Locale.getDefault());
                    resetsuhu();
                }else if(tabLayout.getSelectedTabPosition() == 3){
                    graphViewsuhu.getGridLabelRenderer().setNumHorizontalLabels(7);
                    graphViewsuhu.getViewport().setMinX(xktanah0-315360);
                    legsj.setText("□ Suhu °C   □ Waktu Bulan, Tahun");
                    sdfsuhu=new SimpleDateFormat(  "MMM, yyyy", Locale.getDefault());
                    resetsuhu();
                }
            }
    ...
    public void chartkonf(){
        ...
        graphViewsuhu.getGridLabelRenderer().setTextSize(24f);
        graphViewsuhu.getViewport().setXAxisBoundsManual(true);
        graphViewsuhu.getViewport().setMinX(xktanah0-432);
        graphViewsuhu.getViewport().setMaxX(xktanah0);
    ...
    public void resetsuhu(){
        graphViewsuhu.getGridLabelRenderer().setLabelFormatter(new DefaultLabelFormatter(){
            ...
            public String formatLabel(double valuesuhu, boolean isValueXsuhu){
                if(isValueXsuhu){
                    return sdfsuhu.format(new Date((long) valuesuhu*100000));
                }else{
